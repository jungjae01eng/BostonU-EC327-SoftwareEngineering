...
int main()
{
    ...
    if ((second_y - first_y) <= first_length) {
        if (second_x >= first_x) {  // if true, second_x is on the RIGHT side of first_x
            if ((second_y - first_y) >= 0) {    // if true, second_y is ABOVE the first_y
            ...
            else if ((second_y - first_y) < 0) {    // if true, second_y is BELOW the first_y
                if ((second_y - first_y) > second_height) {
                    print_Do_Not_Intersect();
                    return 0;
                }
                else if ((second_y - first_y) <= second_height) {
                    print_Intersect();
                    return 0;
                }
            }
        }
        else if (second_x < first_x) {  // if true, second_x is on the LEFT side of first_x
            if ((first_y - second_y) >= 0) {    // if true, first_y is ABOVE the second_y
                if ((first_y - second_y) > first_height) {
                    print_Do_Not_Intersect();
                    return 0;
                }
                else if ((first_y - second_y) <= first_height) {
                    print_Intersect();
                    return 0;
                }
            }
            else if ((first_y - second_y) < 0) {    // if true, first_y is BELOW the second_y
